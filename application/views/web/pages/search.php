...
<div class="main">
    <div class="content">
        <div class="content_top">
            <div class="heading">
                <h3>Cari Hp : <b style="color:red"><?php if($search){echo $search;}?></b></h3>
            </div>
            <div class="clear"></div>
        </div>
            ...
            <div class="section group">
                <?php foreach ($chunk_products as $single_products) { ?>
                    <div class="grid_1_of_4 images_1_of_4">
                        ...
                        <p><span class="price"><?php echo $this->cart->format_number($single_products->product_price) ?> Rp.</span></p>
