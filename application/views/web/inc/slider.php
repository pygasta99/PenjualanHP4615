            ...
            <div class="section group">
                ...
                <div class="listview_1_of_2 images_1_of_2">
                    ...
                    <div class="text list_2_of_1">
                        ...
                        <div class="button"><span><a href="<?php echo base_url('single/'.$single_popular->product_id);?>">Tambahkan Keranjang</a></span></div>
                    </div>
                </div>
                <?php }?>
            </div>
            ...
            <div class="flexslider">
                <ul class="slides">
                    ...
                    foreach ($slider_posts as $slider_post) {
                        ?>
                        <li><a href="<?php echo $slider_post->slider_link ?>"><img src="<?php echo base_url() ?>uploads/<?php echo $slider_post->slider_image ?>" alt=""/></a></li><?php } ?>
                </ul>
            </div>
        </section>
        <!-- FlexSlider -->
